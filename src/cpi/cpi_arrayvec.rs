...
#[profile]
pub fn arrayvec_push_account_meta_10(accounts: &[AccountInfo]) -> ArrayVec<AccountMeta<'_>, 10> {
...
#[profile]
pub fn arrayvec_push_account_info_10_ref(
...
#[profile]
pub fn arrayvec_push_account_info_10_clone(
    accounts: &[AccountInfo],
) -> ArrayVec<AccountInfo, 10> {
    let mut vec = ArrayVec::new();
    for i in 0..10 {
...
#[profile]
pub fn arrayvec_push_account_info_10_move(
    accounts: &[AccountInfo],
) -> ArrayVec<AccountInfo, 10> {
    let mut vec = ArrayVec::new();
    for i in 0..10 {
