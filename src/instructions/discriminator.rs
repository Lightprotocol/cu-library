...
pub enum CuLibraryInstruction {
    ...
    CollectVec1Seed = 307,
    CollectVec3Seeds = 308,
    CollectVec16Seeds = 309,
    CollectArrayVec1Seed = 310,
    CollectArrayVec3Seeds = 311,
    CollectArrayVec16Seeds = 312,
    CollectArrayVec3Seeds16Capacity = 313,
    Array3Seeds = 314,
...
impl TryFrom<&[u8]> for CuLibraryInstruction {
    ...
    fn try_from(value: &[u8]) -> Result<Self, Self::Error> {
        ...
        match discriminator {
            ...
            307 => Ok(CuLibraryInstruction::CollectVec1Seed),
            308 => Ok(CuLibraryInstruction::CollectVec3Seeds),
            309 => Ok(CuLibraryInstruction::CollectVec16Seeds),
            310 => Ok(CuLibraryInstruction::CollectArrayVec1Seed),
            311 => Ok(CuLibraryInstruction::CollectArrayVec3Seeds),
            312 => Ok(CuLibraryInstruction::CollectArrayVec16Seeds),
            313 => Ok(CuLibraryInstruction::CollectArrayVec3Seeds16Capacity),
            314 => Ok(CuLibraryInstruction::Array3Seeds),
